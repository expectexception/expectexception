...
class ContactInquiry(models.Model):
    ...
    email = models.EmailField(
        blank=True, help_text="Optional if a phone number is provided instead"
    )
    phone = models.CharField(
        max_length=30,
        blank=True,
        help_text="Contact number for call-back inquiries (e.g. from the chatbot)",
    )
    ...
    source_page = models.CharField(
        max_length=50, blank=True, help_text="Which page the form was submitted from"
    )
