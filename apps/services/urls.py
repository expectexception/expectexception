...
admin_urlpatterns = [
    ...
    path("admin/mongo-status/", AdminMongoStatusView.as_view(), name="admin-mongo-status"),
    path("admin/backups/", AdminBackupView.as_view(), name="admin-backups"),
    ...
    path(
        "admin/downloads/<int:pk>/", AdminDownloadDetailView.as_view(), name="admin-download-detail"
    ),
    path("admin/inquiries/", AdminInquiryListView.as_view(), name="admin-inquiries"),
    path(
        "admin/inquiries/<int:pk>/", AdminInquiryDetailView.as_view(), name="admin-inquiry-detail"
    ),
    path(
        "admin/inquiries/<int:pk>/reply/",
        AdminInquiryReplyView.as_view(),
    ...
    path(
        ...
        AdminToolRestrictionListCreateView.as_view(),
        name="admin-tool-restrictions",
    ),
    path(
        "admin/tool-restrictions/<int:pk>/",
        AdminToolRestrictionDetailView.as_view(),
        name="admin-tool-restriction-detail",
    ),
    path(
        "admin/users/<int:pk>/tool-usage/",
        AdminUserToolUsageView.as_view(),
        name="admin-user-tool-usage",
    ),
...
urlpatterns = (
    [
        ...
        path(
            "pdf-to-doc/status/<str:task_id>/",
            PdfToDocStatusView.as_view(),
            name="pdf-to-doc-status",
        ),
        ...
        path(
            "performance-snapshot/", PerformanceSnapshotView.as_view(), name="performance-snapshot"
        ),
        ...
        path(
            "uptime-robot/monitors/", UptimeMonitorListCreateView.as_view(), name="uptime-monitors"
        ),
        path(
            "uptime-robot/monitors/<int:monitor_id>/",
            UptimeMonitorDetailView.as_view(),
            name="uptime-monitor-detail",
        ),
        path(
            "uptime-robot/heartbeat/<uuid:heartbeat_id>/",
            UptimeHeartbeatReceiverView.as_view(),
            name="uptime-heartbeat",
        ),
        # Audio tools
        path("audio-separator/process", AudioSeparatorView.as_view(), name="audio-separator"),
        path(
            "audio-separator/status/<str:task_id>/",
            AudioSeparatorStatusView.as_view(),
            name="audio-separator-status",
        ),
        ...
        path(
            "webhook/<uuid:endpoint_id>/requests/",
            WebhookRequestsListView.as_view(),
            name="webhook-requests",
        ),
        path(
            "webhook/<uuid:endpoint_id>/requests/<uuid:request_id>/",
            WebhookRequestDetailView.as_view(),
            name="webhook-request-detail",
        ),
        path(
            "webhook/<uuid:endpoint_id>/replay/<uuid:request_id>/",
