...
class ImageAnalysis(models.Model):
    ...
    image = models.ImageField(upload_to="ai_detector/%Y/%m/%d/", help_text="Uploaded image file")
    filename = models.CharField(max_length=255, help_text="Original filename")
    is_ai_generated = models.BooleanField(
        default=False, help_text="Whether the image is detected as AI-generated"
    )
