...
ALLOWED_HOSTS = os.getenv("DJANGO_ALLOWED_HOSTS", "localhost,127.0.0.1").split(",") + [
    "djangobackend",
    "ytd.expectexception.com",
    "api.expectexception.com",
    "expectexception.com",
...
CSRF_TRUSTED_ORIGINS = os.getenv(
    ...
    "https://ytd.expectexception.com",
    "https://api.expectexception.com",
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": ("apps.users.authentication.JITMongoJWTAuthentication",),
...
VAPID_PUBLIC_KEY = os.getenv(
    "VAPID_PUBLIC_KEY",
    "BGcxbIdFOOx06gl9Nt_D0IMsNM1pfe4_nCx2_bB9rSi-fTabOnGvNY1To4WzL6laMTqYcl7ALDQRrbnDoeCBrZk",
)
VAPID_PRIVATE_KEY_PEM = os.getenv(
...
SECURE_CONTENT_SECURITY_POLICY = {
    ...
    "connect-src": (
        ...
        "https://www.expectexception.com",
        "https://ytd.expectexception.com",
        "https://expectexception.onrender.com",
...
FEATURE_FLAGS = {
    ...
    "HEAVY_AI_SERVICES": os.getenv("FEATURE_HEAVY_AI_ENABLED", "True").lower()
    in ("true", "1", "yes"),
    "YT_DOWNLOADER": os.getenv("FEATURE_YT_DOWNLOADER_ENABLED", "True").lower()
    in ("true", "1", "yes"),
