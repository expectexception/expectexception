...
class Conversation(models.Model):
    ...
    session_id = models.CharField(
        max_length=100, blank=True, help_text="Session ID for anonymous users"
    )
    title = models.CharField(
        max_length=200, default="New Chat", help_text="Auto-generated from first message"
    )
    model = models.CharField(
        max_length=50, default="phi3:mini", help_text="Model used for this conversation"
    )
