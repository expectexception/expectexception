...
def get_system_metrics():
    ...
    return {
        ...
        "memory": {"total_gb": mem_total_gb, "used_gb": mem_used_gb, "percent": mem.percent},
        "disk": {"total_gb": disk_total_gb, "used_gb": disk_used_gb, "percent": disk.percent},
        "network": {"sent_mb": bytes_sent_mb, "recv_mb": bytes_recv_mb},
        "gpu": gpu_stats,
        "runtime": {
